        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="w-full md:w-1/2 mb-10 md:mb-0 text-center md:text-left">
            ...
            <div className="flex space-x-4 justify-center md:justify-start">
              ...
              <a href="https://www.upwork.com/freelancers/your-profile" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
